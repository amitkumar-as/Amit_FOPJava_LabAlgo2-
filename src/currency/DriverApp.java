...
public class DriverApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("Please enter number of notes in your countery");
		...
		System.out.println("Before Srting:" + Arrays.toString(currency));
		
		SelectionSort ss = new SelectionSort();
		ss.mySort(currency);
		
		System.out.println("After Srting:" + Arrays.toString(currency));
